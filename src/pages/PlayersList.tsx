...
const PlayersListPage = () => {
  ...
  const loadPlayers = useCallback(async () => {
    try {
      ...
      setErrorMessage(
        error instanceof Error ? error.message : 'Nao foi possivel carregar os jogadores cadastrados.',
      )
    } finally {
      setIsLoading(false)
    }
  ...
  const handleDelete = async (playerId: number) => {
    ...
    try {
      ...
      window.alert(error instanceof Error ? error.message : 'Nao foi possivel excluir o jogador agora.')
    }
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <div className="rounded-2xl border border-wolves-border bg-wolves-card/60 p-4">
          <p className="text-sm text-wolves-muted">Frequencia media</p>
          <p className="text-2xl font-semibold text-white">87%</p>
        </div>
        <div className="rounded-2xl border border-wolves-border bg-wolves-card/60 p-4">
          <p className="text-sm text-wolves-muted">Posicoes cobertas</p>
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 pb-6">
          <div className="relative min-w-[200px] flex-1">
            ...
            <input
              ...
              placeholder="Buscar jogador por nome ou posicao..."
        ...
        <div className="overflow-x-auto">
          ...
          {!isLoading && !errorMessage && filteredPlayers.length === 0 && (
            <div className="rounded-2xl border border-white/10 bg-white/5 px-4 py-6 text-center text-sm text-wolves-muted">
              Nenhum jogador cadastrado ate o momento. Utilize o botao "Novo Jogador" para incluir
              o primeiro membro.
            </div>
          )}
              ...
              <div className="space-y-3 md:hidden">
                {filteredPlayers.map((player) => (
                  ...
                  >
                    ...
                    <div className="mt-3 flex flex-wrap items-center gap-2 text-sm text-wolves-muted">
                ...
                <table className="w-full min-w-[600px] text-sm">
                  <thead>
                    <tr className="text-left text-xs uppercase tracking-wider text-wolves-muted">
                      ...
                      <th className="pb-4">Posicao</th>
                      <th className="pb-4">Frequencia</th>
                      <th className="pb-4">Status</th>
                      <th className="pb-4">Contato</th>
                      <th className="pb-4 text-center">Acoes</th>
                    </tr>
                  </thead>
